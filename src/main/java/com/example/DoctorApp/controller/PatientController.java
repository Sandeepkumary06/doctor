...
import com.example.DoctorApp.model.dataToObj.SignInInput;
...
public class PatientController {
    ...
    @PostMapping("/signup")
    public SignInInput signupPatient(@RequestBody Patient patient) throws NoSuchAlgorithmException {
        return patientService.signupPatient(patient);
    }
    @PostMapping("/signIn")
    public void signInPatient(@RequestBody @Validated SignInInput signInInput) throws NoSuchAlgorithmException, MessagingException {
